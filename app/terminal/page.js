      ...
      <div className={`${mobileIntelTab !== 'order' ? 'hidden md:block' : ''} w-full md:w-[360px] md:flex-shrink-0 border-r border-gray-200 dark:border-white/10 overflow-y-auto scrollbar-thin p-4 space-y-3 bg-white dark:bg-transparent`}>
        ...
        {orderResult && !orderResult.success && orderResult.error === 'Only paid users can place orders.' && (
          <div className="p-6 flex flex-col items-center justify-center text-center gap-3 bg-violet-950/40 border border-violet-500/20 rounded-xl">
            ...
            <div>
              <p className="text-white font-bold text-sm mb-1">Pro Feature</p>
              <p className="text-amber-400 text-xs font-semibold mb-2">Order placement is available on the Pro plan.</p>
              <p className="text-slate-500 text-xs mb-3">Connect your broker and trade directly from TradingVerse with AI-powered order intelligence.</p>
